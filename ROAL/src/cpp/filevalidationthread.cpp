...
{
    Logging::addEntry(LOG_LEVEL_INF, "Set data for validation thread", FUNCTION_NAME);
...
void FileValidationThread::run()
{
    ...
    for(int i = 0; i < files->size(); i++)
    {
        ...
        Logging::addEntry(LOG_LEVEL_INF, "Validating: " + files->at(i), FUNCTION_NAME);
        ...
        if(file.open(QIODevice::ReadOnly))
        {
            ...
            {
                Logging::addEntry(LOG_LEVEL_INF, "Invalid hash, redownloading: " + files->at(i), FUNCTION_NAME);
        ...
        {
            Logging::addEntry(LOG_LEVEL_INF, "File not found, redownloading: " + files->at(i), FUNCTION_NAME);
