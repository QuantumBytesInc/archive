...
private:
        ...
        /**
          * @brief Time the client was open
          * */
        ...
        /**
         * @brief communication to upload logs
         */
        JsonRequest *networkWorker;

        /**
         * @brief gather System Information Class
         */
        SystemInformation SysInfo;

        /**
         * @brief json for upload
         */
        QJsonObject json;

        /**
         * @brief debug variable for Logging
